...
const SingleCreditCard = ({ credit, limit, expiry }: creditProps) => {
  return (
    <div className="max-w-[450px]">
      ...
      <div className="block max-w-[450px] rounded-lg bg-[#fafafa] p-6 shadow-md">
        <div>
          ...
          <p className="pt-3 font-semibold text-[20px]">N{credit}</p>
          <p className="mt-4 text-[#85928e] text-[12px]">
            You can still request up to{" "}
            <span className="text-black font-semibold">N{limit}</span>
          </p>
        </div>
